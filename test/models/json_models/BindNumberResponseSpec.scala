...
class BindNumberResponseSpec extends Specification with TestSupport {
  ...
  "BindNumber" should {
    "success when info is active" in new WithApplication {
      ...
      private val response = BindNumberResponse.handle(new BindingNumber("13279491366", "123", "", Some("3"), "1386849160798"))
    ...
    "success when info is inactive" in new WithApplication {
      ...
      private val response = BindNumberResponse.handle(new BindingNumber("13408654683", "123", "", Some("3"), "0"))
    ...
    "fail when number is invalid" in new WithApplication {
      ...
      private val response = BindNumberResponse.handle(new BindingNumber("987654321", "123", "", Some("3"), "1386849160798"))
    ...
    "fail when token is invalid" in new WithApplication {
      ...
      private val response = BindNumberResponse.handle(new BindingNumber("13402815317", "123", "", Some("3"), "0"))
    ...
    "fail when number is expired" in new WithApplication {
      ...
      private val response = BindNumberResponse.handle(new BindingNumber("22222222222", "123", "", Some("3"), "2"))
