...
class CheckingMessageSpec extends Specification with TestSupport {
  ...
  "CheckChildInfo" should {
    "record daily log after checking in school bus" in new WithApplication {
      ...
      private val create: Long = CheckChildInfo(93740362, "1_1391836223533", checkInTypeCode, 0).create.size
      create must beGreaterThan(1L)
    ...
    "record daily log after checking out school bus" in new WithApplication {
      ...
      private val create: Long = CheckChildInfo(93740362, "1_1391836223533", checkOutTypeCode, 0).create.size
      create must beGreaterThan(1L)
  ...
  "CheckInfo" should {
    "record daily log after entering school" in new WithApplication {
      ...
      private val create: Long = CheckInfo(93740362, "0001234567", 0, checkInSchoolTypeCode, "", 0).create.size
      create must beGreaterThan(1L)
    ...
    "record daily log after leaving school" in new WithApplication {
      ...
      private val create: Long = CheckInfo(93740362, "0001234567", 0, checkOutSchoolTypeCode, "", 0).create.size
      create must beGreaterThan(1L)
    ...
    "record daily log after getting off school bus" in new WithApplication {
      ...
      private val create: Long = CheckInfo(93740362, "0001234567", 0, getOffBusTypeCode, "", 0).create.size
      create must beGreaterThan(1L)
    ...
    "record daily log after getting on school bus" in new WithApplication {
      ...
      private val create: Long = CheckInfo(93740362, "0001234567", 0, getOnBusTypeCode, "", 0).create.size
      create must beGreaterThan(1L)
